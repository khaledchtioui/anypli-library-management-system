                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <div class="modal-tab">
                            ...
                            <div class="product-details-small quickview-active owl-carousel">
                                <a class="active" href="#image-1"><img src="{{ asset('storage/' . $book->image) }}" alt="" /></a>
                                <a href="#image-2"><img src="{{ asset('storage/' . $book->image) }}" alt="" /></a>
                                <a href="#image-3"><img src="{{ asset('storage/' . $book->image) }}" alt="" /></a>
                                <a href="#image-4"><img src="{{ asset('storage/' . $book->image) }}" alt="" /></a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (productModal) {
            productModal.addEventListener('show.bs.modal', event => {
                ...
                const bookData = button.getAttribute('data-bs-whatever')
                const book = JSON.parse(bookData);
                const modalImage = productModal.querySelector('#modal-image');
                modalImage.src = `storage/${book.image}`;
                modalImage.style.width = '400px'; // Change the width of the image to 200 pixels

                const modalTitle = productModal.querySelector('.modal-title')
                const modalYear = productModal.querySelector('.modal-year')
...
<!-- Mirrored from htmldemo.net/koparion/koparion/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Aug 2023 20:11:59 GMT -->
</html>
